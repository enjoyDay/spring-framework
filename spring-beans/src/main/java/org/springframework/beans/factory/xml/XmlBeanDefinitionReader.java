...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	public int loadBeanDefinitions(Resource resource) throws BeanDefinitionStoreException {
		// 用EncodedResource封装资源文件，EncodedResource主要作用是对资源文件的编码进行处理
	...
	public int loadBeanDefinitions(EncodedResource encodedResource) throws BeanDefinitionStoreException {
		...
		try {
			// 从currentResources中获取已经封装的Resource对象并再次从Resource中获取其中的inputStream
			InputStream inputStream = encodedResource.getResource().getInputStream();
			try {
				// InputSource是XML实体的单例输入源
	...
	protected Document doLoadDocument(InputSource inputSource, Resource resource) throws Exception {
		return this.documentLoader.loadDocument(inputSource, getEntityResolver(), this.errorHandler,
				// getValidationModeForResource获取对xml文件的验证模式
	...
	protected int getValidationModeForResource(Resource resource) {
		...
		// 如果不是手动指定的，则进入detectValidationMode
	...
	public int registerBeanDefinitions(Document doc, Resource resource) throws BeanDefinitionStoreException {
		// 使用DefaultBeanDefinitionDocumentReader实例化（反射）BeanDefinitionDocumentReader
		BeanDefinitionDocumentReader documentReader = createBeanDefinitionDocumentReader();
		int countBefore = getRegistry().getBeanDefinitionCount();
		// 加载及注册bean（这个时候在初始化readerContext时也初始化了DefaultNamespaceHandlerResolver），设置readerContext
	...
	public NamespaceHandlerResolver getNamespaceHandlerResolver() {
		if (this.namespaceHandlerResolver == null) {
			// 初始化为DefaultNamespaceHandlerResolver
	...
	protected NamespaceHandlerResolver createDefaultNamespaceHandlerResolver() {
		...
		// 在创建DefaultNamespaceHandlerResolver对象同时也默认设置了handler_mapping为"META-INF/spring.handlers"
